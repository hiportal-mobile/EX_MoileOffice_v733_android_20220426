 ...
 *
 */
public class EmailSecurityDialog extends Dialog {

	private Context context;
	private EditText body = null;
	
	public EmailSecurityDialog(Context context) {
		...
		setContentView(R.layout.mail_security_dialog);
...
//        c.setOnClickListener(this);
	...
	public EmailSecurityDialog(Context context, EditText body) {
		this(context);
		this.body = body;
	}
	...
	public Button getCanBtn() {
		return (Button)findViewById(R.id.can);
	}
