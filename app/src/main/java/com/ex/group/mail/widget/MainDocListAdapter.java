 ...
 *
 */
public class MainDocListAdapter extends ArrayAdapter<EmailMainListData> {
	String TAG = "adapter";
	public MainDocListAdapter(Context a_context, int a_nTextViewResourceId) {
		super(a_context, a_nTextViewResourceId);
	}
	
	public MainDocListAdapter(Context a_context, int a_nTextViewResourceId, EmailMainListData[] a_object) {
