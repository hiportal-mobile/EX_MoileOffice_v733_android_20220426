...
public class OptionAdapter extends ArrayAdapter<String> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(v == null) {
			...
			v = vi.inflate(R.layout.mail_member_option_item, null);
		}

		if(data != null) {
			ImageView checked = (ImageView)v.findViewById(R.id.checked);
			if(isChecked[position]) {
				checked.setImageResource(R.drawable.mail_member_btn_radioon);
			} else {
				checked.setImageResource(R.drawable.mail_member_btn_radio_selector);
			}
