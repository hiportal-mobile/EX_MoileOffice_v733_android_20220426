...
public class HttpConnection implements Runnable {
	...
	public static final String URL_HEADER = "http://store.ex.co.kr/mobilerelay/";
	public static final String URL_LOGININFO = "retrieveLoginInfo.do";
	...
	private String __push(String mPushUrl) throws IOException{
		...
		//Log.d(TAG, "connect = " + header + mRequest.url_tail + "?" + data);
	...
	private String __upload() throws Exception
	{
		...
		String header = URL_HEADER;//URL_HEADER;
		URL url = new URL(header + mRequest.url_tail);
