...
//		setContentView(R.layout.easy_member_membersendemail);
	...
	protected void onPostCreateX() {
		...
		((TextView)findViewById(R.id.title_text)).setText(R.string.easyaproval_sendEmail);
...
//		}
		...
		et.setText("\n\n" + getString(R.string.easyaproval_send_skone));
		et.setMinLines(4);
        ...
        sms.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
            	...
            	if (temp.equals("")) {
            		...
            		m_szDialogMessage = getString(R.string.easyaproval_input_title);
			...
			if (m_szResponseMessage.equals("서비스 요청 성공")) {
				if(m_nRequestType == PEOPLE_MIX_MEMBEREMAIL) {
					if(isMixAndDept) {
						...
						m_szDialogMessage = getString(R.string.easyaproval_request_email_send);
