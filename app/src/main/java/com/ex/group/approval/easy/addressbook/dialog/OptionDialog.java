...
import com.ex.group.approval.easy.addressbook.widget.OptionAdapter;
...
public class OptionDialog extends Dialog implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setCancelable(false);
		setContentView(R.layout.easy_member_option_dialog);
		...
		mAdapter = new OptionAdapter(getContext(), R.layout.easy_member_option_item, mList, mIndex);
