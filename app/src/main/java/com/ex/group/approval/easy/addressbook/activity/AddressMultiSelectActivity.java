...
public class AddressMultiSelectActivity extends BaseActivity {
	...
	protected int assignLayout() {
		...
		return R.layout.easy_member_membermultiselect;
	}
	
	public void onCreateX(Bundle instanceState) 
	{
		super.onCreateX(instanceState);
//		setContentView(R.layout.easy_easy_.easy_member_membermultiselect);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> adapterView, View view, int index,
				...
				if(data.m_bIsChecked) {
					...
					v.setImageResource(R.drawable.easy_member_check_off);
				} else {
					data.m_bIsChecked = true;
					v.setImageResource(R.drawable.easy_member_check_on);
				}
			}
		});
...
//        			if(mType.equals("sms") && !m_bIsChild) {
        			...
        			if(mType.equals("sms")) {
		            	if(count > 50) {
		            		...
		            		m_szDialogMessage = getString(R.string.easyaproval_over_count);
...
//        		name.setTextColor(Color.BLACK);
	        	if(data.m_bIsChecked) {
	        		iv.setImageResource(R.drawable.easy_member_check_on);
	        	} else {
	        		iv.setImageResource(R.drawable.easy_member_check_off);
	        	}
//        	}
